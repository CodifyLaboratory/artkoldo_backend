...
from .models import AboutUs, Contacts, SocialMedia, ContactForm, Terms, ForPartners, PaymentDelivery, SellInfo
from .serializers import AboutUsSerializer, ContactsSerializer, SocialMediaSerializer, \
